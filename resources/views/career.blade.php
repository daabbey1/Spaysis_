<head>
    ...
    <link rel="stylesheet" href=" css/career_style.css">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark sub-head">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-link-txt text-light" href="{{ url('/contact') }}"> CONTACT
                        </a>
                    </li>
                </ul>
    ...
    <!-- Contact Us -->
    <div class="contact">
        <div class="page" style="display: block; text-align:center; font-size:23">
            <span class="page-txt"> Careers at SPAYSIS </span>
        </div>
        {{-- <div class="row">
            <div class="col-3">
                <div class="ghana">
    ...
    <div class="image">
        <div class="img-section">
            <img src="images/complete_.jpg"  alt="" srcset="">
        </div>
    </div>
