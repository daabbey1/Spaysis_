...
<div class="body-section">
                    ...
                    <div class="right-profile">
                        ...
                        <div class="energy">
                            ...
                            <div class="profile-body">
                                When telling any story, visual representation always creates a better understanding of your message. Model Building and
                                Animation enables us to move beyond just diagrams, photographs and illustrations to create multi- dimensional
                                simulations that bring projects to life and give the project stakeholders a clearer interpretation of the project
                                concept. <br>
                                We employ a full array of visualization tools, and full-motion animated sequences to provide dynamic capabilities for
                                analysis, interaction and visualization. With our architectural background and vast experience in all styles of
                                architectural models, we offer you unrivalled experience in this field. We talk your language, grasp your ideas and
                                generally get to grips with understanding and reproducing even the most complicated building. <br> 
                                SPAYSIS Models are staffed with high skilled enthusiastic model makers’ prefect for execution or simultaneous project.
                                We are dedicated to meet all your needs with superior scale model, delivered on schedule, at competitive price budgets.
                            </div>
                        </div>
                        ...
                        <div class="transport">
                            ...
                            <div class="profile-body">
                                Our in-house laser cutting facilities allow us to achieve pinpoint accuracy and superb detailing. From the outset, we
                                can help you design and plan your architectural model, identifying the most appropriate scale, style and level of detail
                                for your particular project. The aim is to ensure your architectural model conveys all the relevant information in the
                                most cost-effective way. The main services rendered by SPAYSIS Models are;<br>
                                Architectural Renderings | Architectural Animation and Virtual Reality | Model Supplies | Architectural Models |Model
    ...
    {{-- Seperator --}}
    <div class="break" style="height: 1vh; background-color:#001744">
                    ...
                    <div class="right-profile">
                        ...
                        <div class="transport">
                            ...
                            <div class="profile-body">
                                ...
                                professional property services team and property managers. Our objective is to handle the
                                day―to day needs of your
                                property, minimize vacancies and maximize your bottom line. Accordingly, a good management
                        ...
                        <div class="consulting">
                            ...
                            <div class="profile-body">
                                ...
                                site locations, demographics, high and best use, master planning and conceptualization. Our
                                advisory services also
                                include the following: Investment Appraisals | Market Intelligence Reports | Market Analysis
                        ...
                        <div class="consulting">
                            ...
                            <div class="profile-body">
                                SPAYSIS Ltd engages in selected property developments and acquisitions in different property
                        ...
                        <div class="consulting">
                            ...
                            <div class="profile-body">
                                Our online property portal provides one of the largest property databases in Uganda, with an
                                extensive range of
                                commercial and residential property listings, attracting a large number of knowledges of the
                                local market supported by
                                aggressive and Innovative Marketing Solutions including the following: E–Marketing | Social
                ...
                <div class="col-6">
                    <div class="right-profile">
                        ...
                        <div class="energy">
                            ...
                            <div class="profile-body">
                                Feasibility Studies |Environmental Impact & Siting Studies |Economic and Technical Analyses
                        ...
                        <div class="consulting">
                            ...
                            <div class="profile-body">
                                Check of drawings| Shop Acceptances| Specialist Site Management & Supervision | Coordination
                        ...
                        <div class="consulting">
                            ...
                            <div class="profile-body">
                                Market Analyses| Tariff studies| Project Development | Strategy & Organization | Financial
