    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block " src="../images/Projects/golden2.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
                <img class="d-block" src="../images/Projects/golden.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block" src="../images/Projects/golde2.jpg" alt="Third slide">
            </div>
            <div class="carousel-item">
            ...
            <tr>
                <td>
                    <span data-target="#carouselExampleIndicators" data-slide-to="0" class="active">
                        <img class=" img-selection" src="../images/Projects/golden2.jpg" alt="Card image cap">
                    </span>
                </td>
                <td>
                    <span data-target="#carouselExampleIndicators" data-slide-to="1">
                        <img class=" img-selection" src="../images/Projects/golden.jpg" alt="Card image cap">
                    </span>
                </td>
                <td>
                    <span data-target="#carouselExampleIndicators" data-slide-to="2">
                        <img class=" img-selection" src="../images/Projects/golen.jpg" alt="Card image cap">
                    </span>
                </td>
                <td>
                    <span data-target="#carouselExampleIndicators" data-slide-to="3">
                        <img class=" img-selection"src="../images/Projects/aa4.pg" alt="image">
                    </span>
                </td>
                <td>
    ...
    <div class="row left-right-info">
        <div class="col-xs-12 col-lg-7 col-xl-7">
            <div class="discription">
                <div class="disc-head">
                    <span class="disc-main-head">Golden Elysée </span>
                </div>
                <div class="disc-body">
                    The School will provide state-of-the-art facilities for children where they can learn and get in touch with the prepared
                    environment. SPAYSIS has been requested by a private client to prepare a feasibility study, develop a business plan with
                    the view of serving as an input for the investor to appraise the project to have an informed decision on the financial
                    and commercial viability of the project and also use the plan as a basis for evaluating the performance of the project.
                </div>
            </div>
        </div>
